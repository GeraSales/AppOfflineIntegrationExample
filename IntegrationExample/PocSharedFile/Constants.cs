...
namespace PocSharedFile
{
    public static class Constants
    {
        ...
        public const string FV_CLASS_NAME = "fvClassName";
        public const string DISTRIBUTOR_CODE = "distributorCode";
        public const string REDIRECT_SERVICE = "redirectService";
        ...
        public const string ERROR_CODE_DESCRIPTION = "errorCodeDescription";
        public const string FV_VENDOR_CODE = "fvVendorCode";
        public const string FV_VENDOR_NAME = "fvVendorName";
        public const string FV_APP_NAME = "fvAppName";
